...
import Dashboard from './view/Administrative/dashboard/index.vue'
import refresh from './view/layout/refresh.vue'
import Home from './view/layout/Home.vue'
import menuList from './view/Administrative/system/menu/list.vue'
import menuAdd from './view/Administrative/system/menu/add.vue'
import menuEdit from './view/Administrative/system/menu/edit.vue'
import systemConfig from './view/Administrative/system/config/add.vue'
import ruleList from './view/Administrative/system/rule/list.vue'
import ruleAdd from './view/Administrative/system/rule/add.vue'
import ruleEdit from './view/Administrative/system/rule/edit.vue'
import positionList from './view/Administrative/structures/position/list.vue'
import positionAdd from './view/Administrative/structures/position/add.vue'
import positionEdit from './view/Administrative/structures/position/edit.vue'
import structuresList from './view/Administrative/structures/structures/list.vue'
import structuresAdd from './view/Administrative/structures/structures/add.vue'
import structuresEdit from './view/Administrative/structures/structures/edit.vue'
import groupsAdd from './view/Administrative/structures/groups/add.vue'
import groupsEdit from './view/Administrative/structures/groups/edit.vue'
import groupsList from './view/Administrative/structures/groups/list.vue'
import usersList from './view/Administrative/accounts/admin/list.vue'
import usersAdd from './view/Administrative/accounts/admin/add.vue'
import usersEdit from './view/Administrative/accounts/admin/edit.vue'
import usersLog from './view/Administrative/accounts/admin/log.vue'
import DbList from './view/Administrative/system/Db/list.vue'
import signlogList from './view/Administrative/system/signlog/list.vue'
import DemoList from './view/Demo/index/list.vue'
import tableList from './view/Demo/table/list.vue'
import tableExp from './view/Demo/table/exp.vue'
import editorList from './view/Demo/editor/list.vue'
import editorExplain from './view/Demo/editor/exp.vue'
import uploadList from './view/Demo/upload/list.vue'
import uploadExp from './view/Demo/upload/exp.vue'
import formList from './view/Demo/form/list.vue'
import formExp from './view/Demo/form/exp.vue'
import excelList from './view/Demo/excel/list.vue'
import excelExp from './view/Demo/excel/exp.vue'
import iconsList from './view/Demo/icons/list.vue'
import iconsExp from './view/Demo/icons/exp.vue'
import Error from './view/Error/404.vue'
import chartsList from './view/Demo/charts/list.vue'
import chartsLine from './view/Demo/charts/line.vue'
import chartsMix from './view/Demo/charts/mix.vue'
