    ...
    export default {
        ...
        methods: {
            fetchData() {
                ...
                this.list = [{id: 1, title:'标题', author: '作者', pageviews: '100', timestamp: '2017.10.15', auditor: '编辑', forecast: 22, importance: 2, display_time: '2017.10.15'},
                    {id: 2, title:'标题', author: '作者', pageviews: '100', timestamp: '2017.10.15', auditor: '编辑', forecast: 22, importance: 2, display_time: '2017.10.15'}
                ]
